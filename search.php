...
<option value="computer_result">Computer</option>
<option value="Civil_result">Civil</option>
<option value="Electronics_result">Electronics</option>
<option value="Garments_result">Garments </option>
<option value="Textile_result">Textile</option>
<option value="Mechanical_result">Mechanical </option>
<option value="Tele_communication_result">Tele communication</option>
<option value="Architecture_result">Architecture</option>
</select>
</td>
</tr>
<td>Semester</td>
