...
include_once('lib/function5.php');
...
$id=$_REQUEST['id'];
     ...
     $query="select * from Mechanical where id='$id'";
...
if($conn==true){
  ...
  header('location:updateMechanical.php?id=$id');
}else{
 ...
 $da="select * from Mechanical_result where sid='$id'";
 $co=$connect -> query($da);
 $cul=$co -> fetch_assoc();
...
<div class="col-md-12">
 <link rel="stylesheet" href="css/new.css">
                                            <section class="panel b-a" style="margin-top:30px;  min-height: 700px;">
												<div class="panel-heading b-b"> <span class="badge bg-warning pull-right">10</span> <a href="#" class="font-bold">Mechanical Department Update result</a> </div>
...
<a href="Mechanical.php" class='btn btn-danger'>Back</a>
  </div>
