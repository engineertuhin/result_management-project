...
<div class="col-md-12">
		...
		<div class="panel-heading b-b"> <span class="badge bg-warning pull-right">10</span> <a href="#" class="font-bold"> Updata notice</a> </div>
    ...
    <form  action="movenotise.php" method="POST" style="padding:5px 30px 30px 30px" enctype="multipart/form-data">
