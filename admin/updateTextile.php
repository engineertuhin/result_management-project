...
include_once('lib/function4.php');
...
$id=$_REQUEST['id'];
     ...
     $query="select * from Textile where id='$id'";
...
if($conn==true){
  ...
  header('location:updateTextile.php?id=$id');
}else{
 ...
 $da="select * from Textile_result where sid='$id'";
 $co=$connect -> query($da);
 $cul=$co -> fetch_assoc();
...
<div class="col-md-12">
 <link rel="stylesheet" href="css/new.css">
                                            <section class="panel b-a" style="margin-top:30px;  min-height: 700px;">
												<div class="panel-heading b-b"> <span class="badge bg-warning pull-right">10</span> <a href="#" class="font-bold">Garments Department Add result</a> </div>
...
<a href="tixtile.php" class='btn btn-danger'>Back</a>
  </div>
