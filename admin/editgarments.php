...
<div class="col-md-12">
 <link rel="stylesheet" href="css/new.css">
                                            <section class="panel b-a" style="margin-top:30px;  min-height: 700px;">
												<div class="panel-heading b-b"> <span class="badge bg-warning pull-right">10</span> <a href="#" class="font-bold">Edit Garments department data</a> </div>
...
<form  action="move_gamrents.php" method="post" enctype="multipart/form-data">                           
