...
$query="update  Architecture set semester='$semester',name='$name',roll='$roll',reg='$reg',department='$departmen',board='$board',image='$img' where id='$data'";
$con=$connect -> query($query);
if($con==true){

   header("location:arctechar.php");
