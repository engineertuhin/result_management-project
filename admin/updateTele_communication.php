...
include_once('lib/function6.php');
...
if($conn==true){
  ...
  header('location:updateTele_communication.php?id=$id');
}else{
 ...
 $da="select * from Tele_communication_result where sid='$id'";
 $co=$connect -> query($da);
 $cul=$co -> fetch_assoc();
...
<div class="col-md-12">
 <link rel="stylesheet" href="css/new.css">
                                            <section class="panel b-a" style="margin-top:30px;  min-height: 700px;">
												<div class="panel-heading b-b"> <span class="badge bg-warning pull-right">10</span> <a href="#" class="font-bold">Tele communication Department update result</a> </div>
...
<a href="Tele_communication.php" class='btn btn-danger'>Back</a>
  </div>
