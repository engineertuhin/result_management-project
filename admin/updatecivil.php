...
include_once('lib/function1.php');
...
if($conn==true){
 ...
 $da="select * from Civil_result where sid='$id'";
 $co=$connect -> query($da);
 $cul=$co -> fetch_assoc();
...
<div class="col-md-12">
 <link rel="stylesheet" href="css/new.css">
                                            <section class="panel b-a" style="margin-top:30px;  min-height: 700px;">
												<div class="panel-heading b-b"> <span class="badge bg-warning pull-right">10</span> <a href="#" class="font-bold">Civil Department Add result</a> </div>
...
<a href="civil.php" class='btn btn-danger'>Back</a>
  </div>
