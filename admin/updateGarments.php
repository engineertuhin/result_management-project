...
include_once('lib/function3.php');
...
if($conn==true){
 ...
 $da="select * from Garments_result where sid='$id'";
 $co=$connect -> query($da);
 $cul=$co -> fetch_assoc();
...
<a href="garmants.php" class='btn btn-danger'>Back</a>
  </div>
